...
local Window = OrionLib:MakeWindow({Name = "Sea Hub", HidePremium = false, IntroText = "Sea Hub", SaveConfig = true, ConfigFolder = "Sea Hub"})
...
OrionLib:MakeNotification({
	Name = "Sea Hub",
	Content = "Sea Hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
IQ:AddToggle({
    ...
    Callback = function(Value)
        ...
        wait(0)
        -- Script generated By Peejayx - Ayayayoo
